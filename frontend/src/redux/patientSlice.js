...
export const fetchDischargedPatients = createAsyncThunk('/patients/fetch-discharged',async()=>{
    try
    {
        const responseDischarged = await axios.get('http://localhost:5000/api/patients/discharged')
